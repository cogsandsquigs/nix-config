...
#
# STUB: this machine does not exist yet. It already inherits every feature under conf/modules/
# (the full personal profile), so filling it in means adding the real hardware details below. The
# placeholder root filesystem and bootloader are what keep it evaluable meanwhile.
#
# The *personal* Linux box. The work machine is a leaner standalone home-manager config --
# conf/hosts/ip-workbox.
{ host, ... }: {
    _class = "nixos";
