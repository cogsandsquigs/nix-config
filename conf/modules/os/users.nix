...
#
# Account attributes live in the portable unit at conf/users/<name>/system.nix, keyed by class because the two
# classes accept different attributes. This selects the matching half. Home configuration for the same
# users flows separately, through conf/modules/os/home-manager.nix.
let
