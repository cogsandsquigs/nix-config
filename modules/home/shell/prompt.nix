{ ... }: {
    ...
    programs.starship = {
        ...
        settings = {
            ...
            format = ''
                [╭─](bright-black) $os$hostname$directory$git_branch$git_commit$git_state$git_metrics$git_status$c$cpp$rust$nodejs$bun$python$go$java$kotlin$scala$package$direnv$fill $cmd_duration$time''${custom.zellij}
