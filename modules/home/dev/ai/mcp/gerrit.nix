# GerritCodeReview/gerrit-mcp-server as a stdio launcher. Used by ./default.nix.
#
...
writeShellApplication {
    ...
    # ./default.nix). Upstream wants a JSON config file, so translate at launch — nothing in the store.
    text = ''
