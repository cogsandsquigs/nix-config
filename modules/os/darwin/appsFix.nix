# Fix for MacOS apps not appearing on spotlight-search. Need to copy the desktop apps because
...
# See: https://gist.github.com/Jabb0/1b7ad92e8ab3065ac999c21edc23311f
{
    darwin =
        ...
        {
            options.my.sys.os.darwin.appsFix.enable =
                tools.opt.mkEnabled "copy Nix .app bundles so Spotlight finds them";

            config = lib.mkIf config.my.sys.os.darwin.appsFix.enable {
